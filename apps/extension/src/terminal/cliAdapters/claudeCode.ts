...
export const CLAUDE_CODE_NOTIFY_COMMAND =
  `printf '\\033]9;Claude Code needs your attention\\007' > ${NOTIFY_REDIRECT_TARGET} 2>/dev/null || true`;
...
export const CLAUDE_CODE_STOP_COMMAND =
  `printf '\\033]9;Claude Code is done\\007' > ${NOTIFY_REDIRECT_TARGET} 2>/dev/null || true`;
