...
// VS Codes mitgeliefertes `vscode.vscode-theme-seti` seinen Icon-Font baut.
//
// HERKUNFT UND LIZENZ
...
// VS Code lädt dieses Set als Icon-Font (ein Zeichen pro Dateityp, Farbe über
...
// #F1DD3F …), VS Code ignoriert die und färbt den Font stattdessen über die
...
const FILE_GLYPH: Record<FileKind, SetiGlyph> = {
  // typescript.svg — VS Code: _typescript
  ts: {
    viewBox: "0 0 32 32",
  ...
  // react.svg — VS Code: _react (typescriptreact)
  tsx: {
    viewBox: "0 0 32 32",
  ...
  // javascript.svg — VS Code: _javascript
  js: {
    viewBox: "0 0 32 32",
  ...
  // config.svg — VS Code: _config (Endung .toml)
  toml: {
    viewBox: "0 0 32 32",
  ...
  // git.svg — VS Code: _git (#41535b, s. o.)
  git: {
    viewBox: "0 0 32 32",
  ...
  // default.svg — VS Code: _default (#d4d7d6, s. o.)
  file: {
...
//  2. Dieselbe Kombination fährt VS Code selbst: 16px-Icons in 22px-Zeilen.
...
//
// 1. Seti kennt nur EINEN Ordner — VS Codes Seti-Theme zeigt an Ordnern
